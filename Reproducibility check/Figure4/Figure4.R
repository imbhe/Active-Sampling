...
param_input <- read_excel("Application/Input/parameter_input coverage_example.xlsx")
...
ggsave(sprintf(paste("Reproducibility check/Reproduced figures/","Replication_95_coverage_plot.png",sep = "")), c1, dpi = 1000, width =160, height =70, unit = "mm")
